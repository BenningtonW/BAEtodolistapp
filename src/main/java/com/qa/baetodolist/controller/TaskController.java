...
public class TaskController {
	...
	public TaskController(TaskController service) {
	...
	public ResponseEntity<Task> getById(@PathVariable long id) {
		return new ResponseEntity<Task>(service.getById(id), HttpStatus.OK);
	}
	...
	public ResponseEntity<Task> update(@PathVariable long id, @RequestBody Task task) {
		return new ResponseEntity<Task>(service.update(id, task), HttpStatus.ACCEPTED);
	}	
		// Delete
